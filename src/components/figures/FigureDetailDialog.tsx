    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
        ...
        {hasBa ? (
          <Tabs defaultValue="slider" className="w-full">
              ...
              <div className="flex flex-col items-center gap-3">
                <div className="grid grid-cols-2 gap-2 w-full">
                  <div className="overflow-hidden rounded-lg border">
                    <img src={beforeImage!.imagePath} alt="Before" className="w-full object-cover aspect-[4/3]" />
                    <p className="py-1 text-center text-xs text-muted-foreground">Before</p>
                  </div>
                  <div className="overflow-hidden rounded-lg border">
                    <img src={afterImage!.imagePath} alt="After" className="w-full object-cover aspect-[4/3]" />
            ...
            <TabsContent value="before" className="mt-4">
              <div className="overflow-hidden rounded-lg">
                <img src={beforeImage!.imagePath} alt="原图" className="w-full object-contain" />
              </div>
            </TabsContent>

            <TabsContent value="after" className="mt-4">
              <div className="overflow-hidden rounded-lg">
                <img src={afterImage!.imagePath} alt="AI 图" className="w-full object-contain" />
              </div>
            </TabsContent>
          </Tabs>
        ) : (
          <div className="overflow-hidden rounded-lg">
            {afterImage && (
              <img src={afterImage.imagePath} alt={figure.title} className="w-full object-contain" />
            )}
          </div>
        )}
